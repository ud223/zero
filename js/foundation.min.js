...
$(document).ready(function() {
	$('.sendemailbtn').click(function() {
		var data = {
			'data':$('.sendemailtxt').val()
		};
		$.ajax({
			url: "http://wx.myoungoo.com/api/test/adddata",
			data: data,
			success: function() {
				alert('Thanks for contacting us. <br/>We will contact you soon.');
				$('.sendemailbtn').prop('disabled', true).text('Sent');
			},
			dataType: 'json'
		});
	});
